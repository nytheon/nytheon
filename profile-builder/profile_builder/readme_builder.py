...
The generated profile README is built entirely from *live* services so the
numbers, badges, language icons and charts update in real time without
...
- stats .......... github-readme-stats (live mirror)
- languages ...... github-readme-stats (top-langs, shows logos)
- streak ......... streak-stats.demolab.com
- activity ....... github-readme-activity-graph.vercel.app
- connect ........ img.shields.io buttons

Note: the canonical github-readme-stats.vercel.app deployment is frequently
suspended, so stats + top-langs are served by the live mirror deployment
github-readme-stats-one.vercel.app. Same service, same real-time data.
"""
...
# Live mirror of github-readme-stats (the canonical vercel.app deployment is
# frequently suspended with "DEPLOYMENT_PAUSED"). Same service + real-time data.
GH_README_STATS_HOST = "github-readme-stats-one.vercel.app"
...
def stats_url(cfg: ProfileConfig) -> str:
    return (
        f"https://{GH_README_STATS_HOST}/api?username="
        f"{cfg.username}&show_icons=true&count_private=true&include_all_commits=true"
        f"&theme={cfg.stats_theme}&hide_border=true&bg_color=0d1117"
        f"&border_radius=16&title_color=58a6ff&icon_color=3fb950"
    )
...
def write_assets(cfg: ProfileConfig, live: LiveData, root: str) -> List[str]:
    ...
    Only the hero banner (branding) and divider are local; every stat, chart
    and icon in the README is a live service URL that needs no files on disk.
    """
    from .svg_assets import build_divider, build_hero_banner
